...
Add a /favorites page displaying all favorite items and collections in a compact, dev-focused list.

## Requirements

- Add star icon button to TopBar linking to /favorites
- Create /favorites route with protection
- Fetch all user favorite items and collections
...
- Sort by most recently favorite (updatedAt)
