  ...
  return (
    <section className="px-6 pt-38 pb-8">
      <ScrollFadeIn className="mx-auto mb-16 max-w-2xl text-center">
        <SectionEyebrow className="mb-5 block">{t("eyebrow")}</SectionEyebrow>
        <h1 className="mb-5 text-3xl leading-[1.1] font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
          ...
          <span className="block text-balance">{t("titleLine2")}</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-3.5">
          <Button size="lg" nativeButton={false} render={<Link href="/register" />}>
            <span className="tracking-[0.14em] uppercase">{t("getStartedFree")}</span>
          </Button>
          <Button size="lg" variant="ghost" nativeButton={false} render={<Link href="#features" />}>
            <span className="tracking-[0.14em] uppercase">{t("seeFeatures")}</span>
          </Button>
        </div>
      </ScrollFadeIn>
